...
func TestFunctions2(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "b64decode without padding remainder 1", fname: "b64decode", value: StringNode("", "QSB0ZXN0IHN0cmluZy4"), result: StringNode("", "A test string.")},

		{name: "b64decode with padding wrong characters", fname: "b64decode", value: StringNode("", "!!!!Non-ASCII-Chars!!!!"), fail: true},
		{name: "b64decode with padding wrong length", fname: "b64decode", value: StringNode("", "QSB0ZXN0IHN0cmluZwU=="), fail: true},
		...
		{name: "is_null nil", fname: "is_null", value: nil, result: NullNode("")},
		{name: "is_null null", fname: "is_null", value: NullNode(""), result: BoolNode("", true)},
		{name: "is_null str", fname: "is_null", value: StringNode("", ""), result: BoolNode("", false)},
		{name: "is_numeric nil", fname: "is_numeric", value: nil, result: NullNode("")},
		{name: "is_numeric null", fname: "is_numeric", value: NullNode(""), result: BoolNode("", false)},
		{name: "is_numeric int", fname: "is_numeric", value: NumericNode("", -123), result: BoolNode("", true)},
		{name: "is_numeric uint", fname: "is_numeric", value: NumericNode("", 123), result: BoolNode("", true)},
		{name: "is_numeric float", fname: "is_numeric", value: NumericNode("", -12.34), result: BoolNode("", true)},
		{name: "is_numeric string", fname: "is_numeric", value: StringNode("", ""), result: BoolNode("", false)},
		{name: "is_numeric bool", fname: "is_numeric", value: BoolNode("", true), result: BoolNode("", false)},
		{name: "is_numeric array", fname: "is_numeric", value: ArrayNode("", nil), result: BoolNode("", false)},
		{name: "is_numeric object", fname: "is_numeric", value: ObjectNode("", nil), result: BoolNode("", false)},
		{name: "is_int nil", fname: "is_int", value: nil, result: NullNode("")},
		{name: "is_int null", fname: "is_int", value: NullNode(""), result: BoolNode("", false)},
		{name: "is_int int", fname: "is_int", value: NumericNode("", -123), result: BoolNode("", true)},
		{name: "is_int uint", fname: "is_int", value: NumericNode("", 123), result: BoolNode("", true)},
		{name: "is_int float", fname: "is_int", value: NumericNode("", -12.34), result: BoolNode("", false)},
		{name: "is_int string", fname: "is_int", value: StringNode("", ""), result: BoolNode("", false)},
		{name: "is_int bool", fname: "is_int", value: BoolNode("", true), result: BoolNode("", false)},
		{name: "is_int array", fname: "is_int", value: ArrayNode("", nil), result: BoolNode("", false)},
		{name: "is_int object", fname: "is_int", value: ObjectNode("", nil), result: BoolNode("", false)},
		{name: "is_uint nil", fname: "is_uint", value: nil, result: NullNode("")},
		{name: "is_uint null", fname: "is_uint", value: NullNode(""), result: BoolNode("", false)},
		{name: "is_uint int", fname: "is_uint", value: NumericNode("", -123), result: BoolNode("", false)},
		{name: "is_uint uint", fname: "is_uint", value: NumericNode("", 123), result: BoolNode("", true)},
		{name: "is_uint float", fname: "is_uint", value: NumericNode("", -12.34), result: BoolNode("", false)},
		{name: "is_uint string", fname: "is_uint", value: StringNode("", ""), result: BoolNode("", false)},
		{name: "is_uint bool", fname: "is_uint", value: BoolNode("", true), result: BoolNode("", false)},
		{name: "is_uint array", fname: "is_uint", value: ArrayNode("", nil), result: BoolNode("", false)},
		{name: "is_uint object", fname: "is_uint", value: ObjectNode("", nil), result: BoolNode("", false)},
		{name: "is_float nil", fname: "is_float", value: nil, result: NullNode("")},
		{name: "is_float null", fname: "is_float", value: NullNode(""), result: BoolNode("", false)},
		{name: "is_float int", fname: "is_float", value: NumericNode("", -123), result: BoolNode("", false)},
		{name: "is_float uint", fname: "is_float", value: NumericNode("", 123), result: BoolNode("", false)},
		{name: "is_float float", fname: "is_float", value: NumericNode("", -12.34), result: BoolNode("", true)},
		{name: "is_float string", fname: "is_float", value: StringNode("", ""), result: BoolNode("", false)},
		{name: "is_float bool", fname: "is_float", value: BoolNode("", true), result: BoolNode("", false)},
		{name: "is_float array", fname: "is_float", value: ArrayNode("", nil), result: BoolNode("", false)},
		{name: "is_float object", fname: "is_float", value: ObjectNode("", nil), result: BoolNode("", false)},
		{name: "is_string nil", fname: "is_string", value: nil, result: NullNode("")},
		{name: "is_string null", fname: "is_string", value: NullNode(""), result: BoolNode("", false)},
		{name: "is_string int", fname: "is_string", value: NumericNode("", -123), result: BoolNode("", false)},
		{name: "is_string uint", fname: "is_string", value: NumericNode("", 123), result: BoolNode("", false)},
		{name: "is_string float", fname: "is_string", value: NumericNode("", -12.34), result: BoolNode("", false)},
		{name: "is_string string", fname: "is_string", value: StringNode("", ""), result: BoolNode("", true)},
		{name: "is_string bool", fname: "is_string", value: BoolNode("", true), result: BoolNode("", false)},
		{name: "is_string array", fname: "is_string", value: ArrayNode("", nil), result: BoolNode("", false)},
		{name: "is_string object", fname: "is_string", value: ObjectNode("", nil), result: BoolNode("", false)},
		{name: "is_bool nil", fname: "is_bool", value: nil, result: NullNode("")},
		{name: "is_bool null", fname: "is_bool", value: NullNode(""), result: BoolNode("", false)},
		{name: "is_bool int", fname: "is_bool", value: NumericNode("", -123), result: BoolNode("", false)},
		{name: "is_bool uint", fname: "is_bool", value: NumericNode("", 123), result: BoolNode("", false)},
		{name: "is_bool float", fname: "is_bool", value: NumericNode("", -12.34), result: BoolNode("", false)},
		{name: "is_bool string", fname: "is_bool", value: StringNode("", ""), result: BoolNode("", false)},
		{name: "is_bool bool", fname: "is_bool", value: BoolNode("", true), result: BoolNode("", true)},
		{name: "is_bool array", fname: "is_bool", value: ArrayNode("", nil), result: BoolNode("", false)},
		{name: "is_bool object", fname: "is_bool", value: ObjectNode("", nil), result: BoolNode("", false)},
		{name: "is_array nil", fname: "is_array", value: nil, result: NullNode("")},
		{name: "is_array null", fname: "is_array", value: NullNode(""), result: BoolNode("", false)},
		{name: "is_array int", fname: "is_array", value: NumericNode("", -123), result: BoolNode("", false)},
		{name: "is_array uint", fname: "is_array", value: NumericNode("", 123), result: BoolNode("", false)},
		{name: "is_array float", fname: "is_array", value: NumericNode("", -12.34), result: BoolNode("", false)},
		{name: "is_array string", fname: "is_array", value: StringNode("", ""), result: BoolNode("", false)},
		{name: "is_array bool", fname: "is_array", value: BoolNode("", true), result: BoolNode("", false)},
		{name: "is_array array", fname: "is_array", value: ArrayNode("", nil), result: BoolNode("", true)},
		{name: "is_array object", fname: "is_array", value: ObjectNode("", nil), result: BoolNode("", false)},
		{name: "is_object nil", fname: "is_object", value: nil, result: NullNode("")},
		{name: "is_object null", fname: "is_object", value: NullNode(""), result: BoolNode("", false)},
		{name: "is_object int", fname: "is_object", value: NumericNode("", -123), result: BoolNode("", false)},
		{name: "is_object uint", fname: "is_object", value: NumericNode("", 123), result: BoolNode("", false)},
		{name: "is_object float", fname: "is_object", value: NumericNode("", -12.34), result: BoolNode("", false)},
		{name: "is_object string", fname: "is_object", value: StringNode("", ""), result: BoolNode("", false)},
		{name: "is_object bool", fname: "is_object", value: BoolNode("", true), result: BoolNode("", false)},
		{name: "is_object array", fname: "is_object", value: ArrayNode("", nil), result: BoolNode("", false)},
		{name: "is_object object", fname: "is_object", value: ObjectNode("", nil), result: BoolNode("", true)},
	}
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
