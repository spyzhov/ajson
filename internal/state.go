...
// GetState provides an ability to hide the base StateTransitionTable type and use interface declaration to get value.
func (s States) GetState(state State, class Class) State {
